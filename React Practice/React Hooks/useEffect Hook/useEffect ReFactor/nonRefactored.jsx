...
// this code would work at the moment
export default function SocialNetwork() {
    const [data, setData] = useState(null);

    // this useEffect has three properties which is fine but can be complicated to look at first glance. Refactoring can make code simplier and easier to read.
    useEffect(() => {
